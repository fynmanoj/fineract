...
public class CryptographyApiResource {
    ...
    private final ToApiJsonSerializer<CryptData> toApiJsonSerializer;
    private final CryptographyReadPlatformService cryptographyReadPlatformService;

    @Autowired
    public CryptographyApiResource(ToApiJsonSerializer<CryptData> toApiJsonSerializer,
    ...
    public String downloadFile(@PathParam("type") @ApiParam(value = "type") final String type) {
