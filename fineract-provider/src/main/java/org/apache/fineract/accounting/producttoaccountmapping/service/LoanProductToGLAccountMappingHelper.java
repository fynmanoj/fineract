...
public class LoanProductToGLAccountMappingHelper extends ProductToGLAccountMappingHelper {
    ...
    public Map<String, Object> populateChangesForNewLoanProductToGLAccountMappingCreation(final JsonElement element,
        ...
        final Long waiverAccountId = this.fromApiJsonHelper.extractLongNamed(
        ...
        switch (accountingRuleType) {
            ...
            case ACCRUAL_PERIODIC:
                populateChangesForAccrualBasedAccounting(changes, fundAccountId, loanPortfolioAccountId, incomeFromInterestId,
                        incomeFromFeeId, incomeFromPenaltyId, writeOffAccountId, waiverAccountId, overPaymentAccountId, transfersInSuspenseAccountId,
    ...
    private void populateChangesForAccrualBasedAccounting(final Map<String, Object> changes, final Long fundAccountId,
            ...
            final Long writeOffAccountId, final Long waiverAccountId, final Long overPaymentAccountId, final Long transfersInSuspenseAccountId,
        ...
        changes.put(LOAN_PRODUCT_ACCOUNTING_PARAMS.LOSSES_WAIVED.getValue(), waiverAccountId);
    ...
    public void handleChangesToLoanProductToGLAccountMappings(final Long loanProductId, final Map<String, Object> changes,
        ...
        switch (accountingRuleType) {
            ...
            case ACCRUAL_PERIODIC:
                ...
                mergeLoanToExpenseAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.LOSSES_WAIVED.getValue(),
                        loanProductId, ACCRUAL_ACCOUNTS_FOR_LOAN.LOSSES_WAIVED.getValue(),
                        ACCRUAL_ACCOUNTS_FOR_LOAN.LOSSES_WAIVED.toString(), changes);

                // liabilities
                mergeLoanToLiabilityAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.OVERPAYMENT.getValue(), loanProductId,
                        CASH_ACCOUNTS_FOR_LOAN.OVERPAYMENT.getValue(), CASH_ACCOUNTS_FOR_LOAN.OVERPAYMENT.toString(), changes);
                mergeLoanToLiabilityAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.NPA_INTEREST_SUSPENSE.getValue(), loanProductId,
                        ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_INTEREST_SUSPENSE.getValue(), ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_INTEREST_SUSPENSE.toString(), changes);
                mergeLoanToLiabilityAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.NPA_FEES_SUSPENSE.getValue(), loanProductId,
                        ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_FEES_SUSPENSE.getValue(), ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_FEES_SUSPENSE.toString(), changes);
                mergeLoanToLiabilityAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.NPA_PENALTIES_SUSPENSE.getValue(), loanProductId,
                        ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_PENALTIES_SUSPENSE.getValue(), ACCRUAL_ACCOUNTS_FOR_LOAN.NPA_PENALTIES_SUSPENSE.toString(), changes);
            break;
        }
    }
