...
public final class AppUserConstants {
    ...
    public static final String IS_SYSTEM_USER = "isSystemUser";
    public static final String SESSION_EXPIRY_SECONDS = "sessionExpirySeconds";
    public static final String ALLOW_MULTIPLE_SESSIONS = "allowMultipleSessions";
    public static final String PREVENT_INTERACTIVE_LOGIN = "preventInteractiveLogin";
